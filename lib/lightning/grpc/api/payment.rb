      ...
      class Payment
        ...
        class PaymentReceiver < Concurrent::Actor::Context
          ...
          def initialize(events, context, publisher, request)
            ...
            context.payment_initiator << Lightning::Payment::Messages::SendPayment[request.amount_msat, request.payment_hash, request.node_id, [], request.short_channel_ids.to_a, 144, '']
          end
