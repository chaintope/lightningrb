...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("lightning/channel/events.proto", :syntax => :proto3) do
    ...
    add_message "lightning.channel.events.ChannelFailed" do
      optional :temporary_channel_id, :string, 1
...
module Lightning
  module Channel
    module Events
      ...
      ChannelFailed = Google::Protobuf::DescriptorPool.generated_pool.lookup("lightning.channel.events.ChannelFailed").msgclass
